...
public class TransactionDAO {
	...
	//	PlatformTransactionManager 인터페이스 객체 대신 TransactionTemplate 클래스 객체를 사용해서 트랜잭션을 처리하기 때문에 주석처리 함.

	//	트랜잭션 처리를 위해 사용했던 PlatformTransactionManager 인터페이스 객체 대신 트랜잭션 템플릿을 사용하기 위해
	//	TransactionTemplate 클래스 객체를 선언한다.
	private TransactionTemplate transactionTemplate;
	
	//	트랜잭션 처리를 위해 사용했던 PlatformTransactionManager 인터페이스 객체를 대신해서 사용할
	//	TransactionTemplate 클래스 객체를 초기화하기 위해 setter 메소드를 선언하고 servlet-context.xml 파일에서 초기화 시킨다.
