...
//	}
	...
	//	============================================================================================================================
	//	servlet-context.xml 파일에서 생성한 mybatis bean(sqlSession)을 사용하기 위해 SqlSessetion 인터페이스 타입의 객체를 생성한다.
	//	servlet-context.xml 파일에서 생성한 mybatis bean을 자동으로 SqlSessetion 인터페이스 타입의 객체에 넣어주도록 하기 위해서
