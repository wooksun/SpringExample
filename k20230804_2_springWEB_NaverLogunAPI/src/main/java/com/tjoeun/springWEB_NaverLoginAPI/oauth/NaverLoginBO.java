...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "ZDGFwHGsm_cR5T_RVhJ0";
	private final static String CLIENT_SECRET = "ktiaqEyWls";
	private final static String REDIRECT_URI = "http://localhost:9090/springWEB_NaverLogunAPI/callback";
